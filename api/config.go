...
func (configApi *ConfigApi) UpdateWebsite(c *gin.Context) {
	...
	response.FailWithMessage("Successfully updated website.", c)
}
...
func (configApi *ConfigApi) UpdateSystem(c *gin.Context) {
	...
	response.OkWithMessage("Successfully update system", c)
}
...
func (configApi *ConfigApi) UpdateEmail(c *gin.Context) {
	...
	response.OkWithMessage("Successfully update email", c)
}
...
func (configApi *ConfigApi) UpdateQQ(c *gin.Context) {
	...
	response.OkWithMessage("Successfully update QQ", c)
}
...
func (configApi *ConfigApi) UpdateQiniu(c *gin.Context) {
	...
	response.OkWithMessage("Successfully update Qiniu", c)
...
func (configApi *ConfigApi) UpdateJwt(c *gin.Context) {
	...
	response.OkWithMessage("Successfully update jwt", c)
}
...
func (configApi *ConfigApi) UpdateGaode(c *gin.Context) {
	...
	response.OkWithMessage("Successfully update Gaode", c)
}
