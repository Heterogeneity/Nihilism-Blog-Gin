...
--
-- Host: localhost    Database: blog_go
-- ------------------------------------------------------
...
CREATE TABLE `feedbacks` (
  ...
  KEY `fk_feedbacks_user` (`user_uid`),
  CONSTRAINT `fk_feedbacks_user` FOREIGN KEY (`user_uid`) REFERENCES `users` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `address` longtext,
  `signature` varchar(191) DEFAULT '这个用户很懒，什么都没有写。',
...
-- Dump completed on 2025-08-21 11:11:42
